        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="space-y-2">
              <h2 className="text-4xl lg:text-6xl font-bold text-zinc-100">Hi, I am</h2>
              <h1 className="text-4xl lg:text-6xl font-bold text-primary">Salik</h1>
            </div>

            <h3 className="text-2xl lg:text-3xl text-zinc-100">
              Frontend Engineer with full-stack capabilities
            </h3>

            <p className="text-lg text-zinc-400 max-w-xl">
              An enthusiastic and passionate coder with an eye for detail and a focus to produce
              quality work. Can wear multiple hats and be tech agnostic.
            </p>
