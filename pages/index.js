  ...
  return (
    <div>
      ...
      <main className="pt-20 lg:pt-0">
        <div className="h-screen lg:h-screen hero flex flex-col lg:flex-row justify-center items-center">
          <div className="intro text-center w-5/6 lg:text-left lg:w-1/3">
            ...
            <p className="bio bg-gray-100 rounded-md shadow-lg   p-5 text-xl text-justify mt-8">
              ...
              keep in consideration the performance of applications and always
              try to look for optimizations as much as possible.
            </p>
          </div>
          <img
